      ...
      <div className="bg-white rounded-card border border-border-light shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-border-light bg-slate-50/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-[18px] font-bold text-heading-dark leading-tight">System Settings</h2>
              <p className="text-[12px] text-gray-text font-semibold">Configure connection protocols, LLM engines, and preferences.</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSave} className="p-6 space-y-6">
          ...
          <div className="space-y-4 border-b border-slate-100 pb-6">
            <h3 className="text-[14px] font-bold text-heading-dark flex items-center gap-2">
              ...
              <span>Large Language Model Engine Configuration</span>
            </h3>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <span className="text-[12px] text-gray-text font-bold uppercase tracking-wider">LLM Provider</span>
                <select
                  value={llmProvider}
              ...
              <div className="space-y-1.5">
                <span className="text-[12px] text-gray-text font-bold uppercase tracking-wider">Model Variant</span>
                <select
                  value={llmModel}
              ...
              <div className="md:col-span-2 space-y-1.5">
                <span className="text-[12px] text-gray-text font-bold uppercase tracking-wider">API Authentication Token</span>
                <input
                  type="password"
                  value={apiKey}
          ...
          <div className="space-y-4 border-b border-slate-100 pb-6">
            <h3 className="text-[14px] font-bold text-heading-dark flex items-center gap-2">
              ...
              <span>Database Server Linkage</span>
            </h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-btn border border-slate-100 bg-slate-50">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <span className="text-[13px] font-bold text-heading-dark block leading-tight">PostgreSQL (Primary FIR database)</span>
              ...
              <div className="flex items-center justify-between p-3 rounded-btn border border-slate-100 bg-slate-50">
                <div className="flex items-center gap-2.5">
                  <div className="w-2 h-2 rounded-full bg-green-500" />
                  <div>
                    <span className="text-[13px] font-bold text-heading-dark block leading-tight">Neo4j (Criminal Network Graph database)</span>
              ...
              <div className="flex items-center justify-between p-3 rounded-btn border border-slate-100 bg-slate-50">
                <div className="flex items-center gap-2.5">
                  <div className="w-2 h-2 rounded-full bg-green-500" />
                  <div>
                    <span className="text-[13px] font-bold text-heading-dark block leading-tight">Redis (Session & History Cache)</span>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <span className="text-[13px] font-bold text-heading-dark block leading-tight">Shift Mode theme</span>
                <span className="text-[11px] text-slate-500 font-semibold">Toggle between Day Work (Light) and Night Work (Dark) dashboard workspace.</span>
              </div>
          ...
          <div className="flex items-center justify-between border-t border-slate-100 pt-6 mt-6">
            <span className="text-[11px] text-gray-text font-semibold flex items-center gap-1">
              ...
              <span>Restricted access to settings in state police admin credentials</span>
            </span>
