...
class CaseMaster(Base):
    ...
    police_station_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("unit.unit_id"), nullable=True)
    case_category_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("case_category.case_category_id"), nullable=True)
    gravity_offence_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("gravity_offence.gravity_offence_id"), nullable=True)
    crime_major_head_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("crime_head.crime_head_id"), nullable=True)
    crime_minor_head_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
    case_status_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("case_status_master.case_status_id"), nullable=True)
    ...
    officer: Mapped["Employee | None"] = relationship(back_populates="cases", foreign_keys=[police_person_id])
...
class ComplainantDetails(Base):
    ...
    case_id: Mapped[int] = mapped_column(Integer, ForeignKey("case_master.case_id"), nullable=False)
